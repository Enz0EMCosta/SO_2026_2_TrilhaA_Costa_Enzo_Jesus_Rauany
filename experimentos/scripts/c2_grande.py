...
PROMPT = """Explique detalhadamente como um sistema operacional gerencia os recursos de um computador.
Na resposta, aborde os seguintes aspectos: gerenciamento de processos, escalonamento da CPU,
threads, memória principal, memória virtual, sistema de arquivos, dispositivos de entrada e saída,
interrupções, chamadas de sistema e mecanismos de proteção e segurança.
Explique também como esses componentes se relacionam durante a execução simultânea de vários
programas. Organize a explicação de maneira didática, utilizando aproximadamente 10 parágrafos."""
